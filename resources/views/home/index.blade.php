            ...
            <div class="row">
                <div class="col-lg-15">
                    <div class="about-content mt-50">
                        ...
                        <h4 class="about-title"><b>{{ $about->title }}</b></h4>
                            ...
                            {{-- CARD --}}
                                <div class="row pb-5 mb-4">
                                    ...
                                    <div class="card rounded shadow-sm border-0 h-100">
                                        <div class="card-body p-4"><img src="/image/{{ $visi->image }}" alt="" class="img-fluid d-block mx-auto mb-3">
                                            <h5><strong> <a href="#" style="color: rgba(167, 73, 255, 0.918)">{{ $visi->title }} </a></h5></strong><br>
                                            <p class="small text-muted"><b>{{ $visi->description }}</b></p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text text-center pt-20">
                            <p>Copyright © 2022. By: <a href="https://uideck.com" rel="nofollow">XSIS Berkarya</a></p>
                        </div> <!-- copyright text -->
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
